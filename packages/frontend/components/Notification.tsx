...
import backgroundImage from '../public/img/bg.jpg';
...
export default function Notification({ show, setShow }: NotificationProps) {
  ...
  return (
    <>
      ...
      <div
        aria-live="assertive"
        className="pointer-events-none mt-20 fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6"
      >
        <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
          ...
          >
            <div
              style={{
                backgroundImage: `linear-gradient(rgba(253, 255, 255, 0.6), rgba(255, 255, 255, 0.9)) ,url('${backgroundImage.src}')`,
                backgroundSize: 'cover',
              }}
              className="pointer-events-auto flex w-full max-w-md divide-x divide-gray-200 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5"
            >
              <div className="flex w-0 flex-1 items-center p-4">
                <div className="w-full">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Congratulations your have earned a reward! You can claim it
                    now or dismiss this message.
                  </p>
                </div>
              </div>
